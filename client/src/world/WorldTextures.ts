 ...
 *
 * There is not one image file in this build. The whole toy-brick look - the
 * studded green ground, the salmon brick walls, the plank bridges, the gold
 * finish pads and the cloudy sky - costs a few kilobytes of code and nothing
 * at all against the 12 MB budget.
 *
...
export class WorldTextures {
  ...
  /** Salmon brick, for the walls that box the whole course in. */
  ...
  /** Weathered stone blocks, for the ruins. */
