...
const main = async (): Promise<void> => {
  ...
  if (clientConfig.debug) {
    ...
    (window as Window & { __evolve?: DebugHandle }).__evolve = { game, loop };
  }

  // Hidden only on a REAL join. Speed, levels, Wins and evolutions are all
