  ...
  applyInput(
    ...
    stepPlayer(
      ...
      sanitiseInput(message),
      {
        ...
        // The authoritative rebirth count, which is what decides whether a
        // belt under the mount is running. Read off the server's own state so
        // no message can carry it.
