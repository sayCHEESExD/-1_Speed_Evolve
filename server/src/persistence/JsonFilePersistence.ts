    ...
    try {
      ...
      for (const [id, value] of Object.entries(raw)) {
        ...
        profiles.set(id, {
          ...
          // A profile written before the roster existed unlocks none, which
          // `ProfileStore.restore` ORs the free starter into rather than
          // leaving the player unmounted.
          ...
          // Same again for auras and the upgrade pad: a profile written before
          // either existed reads as zero, and zero is exactly what "owns no
          // auras" and "no pad recorded" already mean downstream.
